...
public class DateChooserJButton extends JButton {
 ...
 public DateChooserJButton(JDialog f) {
	 this(getNowDate());
	 this.f = f;
	 }
 ...
 private class DateChooser extends JPanel implements ActionListener,ChangeListener {
  ...
  private JDialog createDialog(JDialog f) {
   JDialog result = new JDialog(f, "日期时间选择", true);
...
//   if (dialog == null || dialog.getOwner() != owner)
	  if (dialog == null || dialog.getOwner() != f){
		  dialog = createDialog(f);
	  }
   dialog.setLocation(getAppropriateLocation(f, position));
   flushWeekAndDay();
   dialog.show();
  }
